...
if global.typer = 4 then SCR_TEXTSETUP(fnt_maintext,c_white,x+20,y+20,view_xview[view_current]+290,0,1,snd_txttor,8,18) //main toriel
if global.typer = 5 then SCR_TEXTSETUP(fnt_maintext,c_white,x+20,y+20,view_xview[view_current]+290,0,1,SND_TXT1,8,18) //main overworld
...
if global.typer = 9 then SCR_TEXTSETUP(fnt_maintext,c_white,x+20,y+20,view_xview[view_current]+290,0,1,snd_floweytalk1,8,18) //flowey overworld
if global.typer = 10 then SCR_TEXTSETUP(fnt_maintext,c_white,x+20,y+20,view_xview[view_current]+290,0,1,snd_nosound,8,18) //main overworld SILENT
if global.typer = 11 then SCR_TEXTSETUP(fnt_maintext,c_white,x+20,y+20,view_xview[view_current]+290,0,2,SND_TXT2,9,18) //intro
...
if global.typer = 16 then SCR_TEXTSETUP(fnt_maintext,c_white,x+20,y+20,view_xview[view_current]+290,1.2,2,snd_floweytalk2,8,18) //evilflowey overworld
if global.typer = 17 then SCR_TEXTSETUP(fnt_comicsans,c_white,x+20,y+20,view_xview[view_current]+290,0.8,1,snd_txtsans,8,18) //sas overworld
if global.typer = 18 then SCR_TEXTSETUP(fnt_papyrus,c_white,x+20,y+20,view_xview[view_current]+290,0,1,snd_txtpap,11,18) //pap overworld
if global.typer = 19 then SCR_TEXTSETUP(fnt_papyrus,c_white,x+20,y+20,view_xview[view_current]+290,0,1,snd_txtpap,15,18) //pap all capitals overworld
